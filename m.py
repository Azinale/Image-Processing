...
for i in range(0,3):
    ...
    # Enable interaction for the plane widget
    planeWidgetArray[i].InteractionOn();
...
for i in range(0,3):
    ...
    # Enable the reslice cursor representation visibility
    resliceCursorRepArray[i].GetResliceCursorActor().VisibilityOn()
...
RendererArray[0].AddActor(outlineActor);
RendererArray[1].AddActor(outlineActor);
RendererArray[2].AddActor(outlineActor);
