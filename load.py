...
def setDicomPath():
    ...
    fileName = r'C:\Users\lalal\Desktop\imageProcessing\demo\manifest-1701814559353\QIN LUNG CT\QIN-LSC-0009\09-13-2000-1-CT Thorax wCont-24434\7.000000-RENAL VEN.  3.0  B30f-45454'
    print(fileName)
    return fileName
